package org.halimatussyadiyah.pmb.provider;
...
import static org.halimatussyadiyah.pmb.constant.Constants.*;
...
public class TokenProvider {
    ...
    public String createAccessToken(UserPrincipal userPrincipal) {
        return JWT.create().withIssuer(HAlIMATUS_SYADIYAH_APPLICATION)
                .withAudience(CUSTOMER_MANAGEMENT_SERVICE)
                .withIssuedAt(new Date())
                .withSubject(String.valueOf(userPrincipal.getUsers().getId()))
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(HAlIMATUS_SYADIYAH_APPLICATION).build();
